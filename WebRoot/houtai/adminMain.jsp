    ...
    <div id="sidebar" style="OVERFLOW-Y: auto; OVERFLOW-X:hidden;">
        <ul>
            ...
            <li class="submenu"> 
                ...
                <ul>
                	<li><a class="menu_a" link="<%=basePath%>admin/adminmima.jsp"><i class="icon icon-caret-right"></i>修改密码</a></li>
                	<li><a class="menu_a" link="<%=basePath%>admin/rizhi.jsp"><i class="icon icon-caret-right"></i>登录日志</a></li>
                </ul>
            </li>
            ...
            <li class="submenu"> 
				...
				<%for(int j = 0; j < jcdaohangslist.get(i).size(); j++){ %>
                	<li><a class="menu_a" link="<%=basePath%>admin/<%=jcdaohangslist.get(i).get(j).getJcdaohangNeirong() %>"><i class="icon icon-caret-right"></i><%=jcdaohangslist.get(i).get(j).getJcdaohangName() %></a></li>
                <%} %>
				</ul>
            </li>
			<%} %>
